<div class="modal fade edit30-{{ $i->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <h1 class="text-center mb-5 mt-5"> Edit Titre Service Prime and Boutton</h1>
        <form action="/servicePrime/{{ $i->id }}" method="POST">
            @csrf
            @method("put")
            @if ($errors->any())
